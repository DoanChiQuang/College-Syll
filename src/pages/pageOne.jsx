...
const PageOne = ({ syll, syllDispatch, useHook }) => {
    ...
    useEffect(() => {
        if (syll.value.placeOfBirth.provinceId)
            fetchDistrictData(
                'placeOfBirth',
                syll.value.placeOfBirth.provinceId
            )(syllDispatch);
        if (syll.value.homeTown.provinceId)
            fetchDistrictData(
                'homeTown',
                syll.value.homeTown.provinceId
            )(syllDispatch);
        if (syll.value.placeOfRegistered.provinceId)
            fetchDistrictData(
                'placeOfRegistered',
                syll.value.placeOfRegistered.provinceId
            )(syllDispatch);
        if (syll.value.placeOfLiving.provinceId)
            fetchDistrictData(
                'placeOfLiving',
                syll.value.placeOfLiving.provinceId
            )(syllDispatch);
    }, [
        syll.value.placeOfBirth.provinceId,
        syll.value.homeTown.provinceId,
    ...
    useEffect(() => {
        if (syll.value.placeOfBirth.districtId)
            fetchWardData(
                'placeOfBirth',
                syll.value.placeOfBirth.districtId
            )(syllDispatch);
        if (syll.value.homeTown.districtId)
            fetchWardData(
                'homeTown',
                syll.value.homeTown.districtId
            )(syllDispatch);
        if (syll.value.placeOfRegistered.districtId)
            fetchWardData(
                'placeOfRegistered',
                syll.value.placeOfRegistered.districtId
            )(syllDispatch);
        if (syll.value.placeOfLiving.districtId)
            fetchWardData(
                'placeOfLiving',
    ...
    return (
        <Box className="flex flex-col space-y-4">
            ...
            <DatePicker
                ...
                onChange={(datetime) =>
                    onChangeTextField('birthday', datetime)(syllDispatch)
                }
                format="DD/MM/YYYY"
            ...
            <Box className="space-y-2">
                ...
                <Box className="flex space-x-4">
                    <Autocomplete
                        value={SelectedValue(
                            syll.value.placeOfBirth.address.province,
                            syll.value.placeOfBirth.provinceId
                        )}
                        onChange={(e, item) =>
                            onChangeTextField('placeOfBirth', {
                                ...syll.value.placeOfBirth,
                                provinceId: item ? item.id : null,
                                districtId: null,
                                wardId: null,
                            })(syllDispatch)
                        }
                    ...
                    <Autocomplete
                        value={SelectedValue(
                            syll.value.placeOfBirth.address.district,
                            syll.value.placeOfBirth.districtId
                        )}
                        onChange={(e, item) =>
                            onChangeTextField('placeOfBirth', {
                                ...syll.value.placeOfBirth,
                                districtId: item ? item.id : null,
                                wardId: null,
                            })(syllDispatch)
                        }
                        disablePortal
                    ...
                    <Autocomplete
                        value={SelectedValue(
                            syll.value.placeOfBirth.address.ward,
                            syll.value.placeOfBirth.wardId
                        )}
                        onChange={(e, item) =>
                            onChangeTextField('placeOfBirth', {
                                ...syll.value.placeOfBirth,
                                wardId: item ? item.id : null,
                            })(syllDispatch)
                        }
                        disablePortal
            ...
            <Box className="space-y-2">
                ...
                <Box className="flex space-x-4">
                    <Autocomplete
                        value={SelectedValue(
                            syll.value.homeTown.address.province,
                            syll.value.homeTown.provinceId
                        )}
                        onChange={(e, item) =>
                            onChangeTextField('homeTown', {
                                ...syll.value.homeTown,
                                provinceId: item ? item.id : null,
                                districtId: null,
                                wardId: null,
                    ...
                    <Autocomplete
                        value={SelectedValue(
                            syll.value.homeTown.address.district,
                            syll.value.homeTown.districtId
                        )}
                        onChange={(e, item) =>
                            onChangeTextField('homeTown', {
                    ...
                    <Autocomplete
                        value={SelectedValue(
                            syll.value.homeTown.address.ward,
                            syll.value.homeTown.wardId
                        )}
                        onChange={(e, item) =>
                            onChangeTextField('homeTown', {
                                ...syll.value.homeTown,
            ...
            <Autocomplete
                value={SelectedValue(
                    syll.value.nation.data,
                    syll.value.nation.nationId
                )}
                onChange={(e, item) =>
                    onChangeTextField('nation', {
                        ...syll.value.nation,
                        nationId: item ? item.id : null,
                    })(syllDispatch)
                }
                disablePortal
            ...
            <Autocomplete
                value={SelectedValue(
                    syll.value.religion.data,
                    syll.value.religion.religionId
                )}
                onChange={(e, item) =>
                    onChangeTextField('religion', {
                        ...syll.value.religion,
                        religionId: item ? item.id : null,
                    })(syllDispatch)
                }
                disablePortal
            ...
            <Box className="space-y-2">
                ...
                <Box className="flex space-x-4">
                    <Autocomplete
                        value={SelectedValue(
                            syll.value.placeOfRegistered.address.province,
                            syll.value.placeOfRegistered.provinceId
                        )}
                        onChange={(e, item) =>
                            onChangeTextField('placeOfRegistered', {
                    ...
                    <Autocomplete
                        value={SelectedValue(
                            syll.value.placeOfRegistered.address.district,
                            syll.value.placeOfRegistered.districtId
                        )}
                        onChange={(e, item) =>
                            onChangeTextField('placeOfRegistered', {
                    ...
                    <Autocomplete
                        value={SelectedValue(
                            syll.value.placeOfRegistered.address.ward,
                            syll.value.placeOfRegistered.wardId
                        )}
                        onChange={(e, item) =>
                            onChangeTextField('placeOfRegistered', {
                                ...syll.value.placeOfRegistered,
            ...
            <Box className="space-y-2">
                ...
                <Box className="flex space-x-4">
                    <Autocomplete
                        value={SelectedValue(
                            syll.value.placeOfLiving.address.province,
                            syll.value.placeOfLiving.provinceId
                        )}
                        onChange={(e, item) =>
                            onChangeTextField('placeOfLiving', {
                    ...
                    <Autocomplete
                        value={SelectedValue(
                            syll.value.placeOfLiving.address.district,
                            syll.value.placeOfLiving.districtId
                        )}
                        onChange={(e, item) =>
                            onChangeTextField('placeOfLiving', {
                    ...
                    <Autocomplete
                        value={SelectedValue(
                            syll.value.placeOfLiving.address.ward,
                            syll.value.placeOfLiving.wardId
                        )}
                        onChange={(e, item) =>
                            onChangeTextField('placeOfLiving', {
                                ...syll.value.placeOfLiving,
